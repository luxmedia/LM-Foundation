...
<html class="no-js" lang="en" dir="ltr">
  ...
  <div class="marketing off-canvas-wrap" data-offcanvas>
      ...
      <div class="topbar__wrap topbar__wrap--fixed">
        <div class="row">
          <div class="sml-12 col">
            ...
            <nav class="topbar expanded" data-topbar>
              <div class="logo-wrap">
                <div class="logo">
                  <h2><a href="http://foundation.zurb.com/">LM-Foundation</a></h2>
                </div>
              </div>
...
<div class="row circle-list skill-list">
  ...
  <hr class="dashed hide-for-med-up">
...
<section class="what-comes-with">
  ...
  <div class="row collapse">
    <div class="sml-6 col border-none">
      <p>6</p>
    </div>
    <div class="sml-6 col">
      <p>6</p>
  ...
  <div class="row collapse">
    <div class="sml-4 col border-none">
      <p>4</p>
      <div class="row">
        <div class="sml-4 col border-none">
          <p>4</p>
    ...
    <div class="sml-4 col border-none">
      <p>4</p>
      <div class="row">
        <div class="sml-3 col border-none">
          <p>3</p>
        </div>
        <div class="sml-9 col">
          <p>9</p>
  ...
  <div class="row">
  <div class="sml-6 col">
    <a href="#" class="btn btn--exp">Default</a>
  </div>
  <div class="sml-6 col">
    <a href="#" class="btn btn--secondary btn--exp">Secondary</a>
  </div>
  <div class="sml-6 col">
    <a href="#" class="btn btn--success btn--exp">Success</a>
  </div>
  <div class="sml-6 col">
    <a href="#" class="btn btn--alert btn--exp">Alert</a>
  </div>
  <div class="sml-6 col">
    <a href="#" class="btn btn--warning btn--exp">Warning</a>
  </div>
  <div class="sml-6 col">
    <a href="#" class="btn btn--info btn--exp">Info</a>
  </div>  
</div>
<div class="row">
  <div class="sml-4 col">
    <a href="#" class="btn btn--exp btn--flat">Flat</a>
  </div>
  <div class="sml-4 col">
    <a href="#" class="btn btn--rad btn--exp">Radius</a>
  </div> 
  <div class="sml-4 col">
    <a href="#" class="btn btn--rnd btn--exp">Round</a>
  </div>
</div>
<section class="gs-buttongroup">
  <div class="row"> 
    <div class="sml-12 col">
      <ul class="btn-group expand btn-group--round">
        <li><a href="#" class="btn">Round</a></li>
        <li><a href="#" class="btn">Button</a></li>
        <li><a href="#" class="btn">Group</a></li>
      </ul>
    </div>
  </div>
</section>
<div class="row gs-hoverbutton">
  <div class="sml-12 col">
    <a href="#" class="btn btn--exp btn--split">Split Button <span data-dropdown="drop" class="toggler"></span></a><br>
    <ul id="drop" class="expand f-dropdown" data-dropdown-content>
      <li><a href="#">This is a link</a></li>
      <li><a href="#">This is another</a></li>
      <li><a href="#">Yet another</a></li>
    </ul>
    <a href="#" class="btn btn--split btn--split--nopip">Custom Pip<span><i class="fi-arrow-down"></i></span></a>
  </div>
  <div class="sml-12 col">
    <a href="#" class="btn btn--alert btn--exp" data-dropdown="hover1" data-options="is_hover:true">Hover &amp; Click Button</a><br>
  ...
  <nav class="topbar" data-topbar>
    ...
    <section class="topbar-section">
      <ul class="right">
        <li class="has-form">
          <div class="row collapse">
            <div class="sml-8 lrg-7 col">
              <input type="text" placeholder="Search">
            </div>
            <div class="sml-3 lrg-3 end col">
              <a href="#" class="btn btn--exp btn--small">Go</a>
            </div>
          </div>
        </li>
        <li class="has-dropdown">
  ...
  <div class="icon-bar icon-bar--five-up">
    <a class="item">
      <i class="fi-home"></i>
    </a>
    <a class="item">
...
<pre><code class="language-html"><div class="code-container"><span class="tag">&lt;<span class="title">form</span>&gt;</span>
  ...
  <span class="tag">&lt;<span class="title">div</span> <span class="attribute">class</span>=<span class="value">"row"</span>&gt;</span>
    ...
    <span class="tag">&lt;/<span class="title">div</span>&gt;</span>
    <span class="tag">&lt;<span class="title">div</span> <span class="attribute">class</span>=<span class="value">"lrg-4 col"</span>&gt;</span>
      <span class="tag">&lt;<span class="title">div</span> <span class="attribute">class</span>=<span class="value">"row collapse"</span>&gt;</span>
...
<hr>
  ...
  <?php require_once("includes/scripts-bottom.js"); ?>
