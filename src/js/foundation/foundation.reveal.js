  ...
  Foundation.libs.reveal = {
    ...
    show : function (el, css) {
      ...
      if (css) {
        ...
        return el.css(css).show().css({opacity : 1}).addClass('is-open').trigger('opened.fndtn.reveal');
      }
    ...
    hide : function (el, css) {
      ...
      if (css) {
        ...
        return el.hide().css(css).removeClass('is-open').trigger('closed.fndtn.reveal');
      }
